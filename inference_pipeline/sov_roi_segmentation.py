...
# Example usage:
# model_path = '/mhgp003-v1/kanpur/data_cardiovision/valve_anatomy_classification/models/yolov8_segmentation_run8_weights_best.pt'
# segmenter = VideoSegmenter(model_path)
# input_video_path = 'temp_output_removed_crosshair.mp4'
# output_video_path = 'temp_output_Segmented.mp4'
