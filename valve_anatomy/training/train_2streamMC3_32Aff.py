# training/train_2stream_attention.py
...
from model.TwoStreamMC3_32Aff import TwoStreamCNN
...
model = TwoStreamCNN(num_classes=len(train_dataset.class_to_idx)).to(device)
...
for epoch in range(1, EPOCHS + 1):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), "best_two_stream_model_attention.pth")
