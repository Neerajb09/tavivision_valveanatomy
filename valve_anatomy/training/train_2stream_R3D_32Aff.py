# training/train_2stream_r3d_attn.py
...
from model.TwoStream_R3D_32Aff import TwoStreamR3DAttn
...
model = TwoStreamR3DAttn(num_classes=len(train_dataset.class_to_idx)).to(device)
...
for epoch in range(1, EPOCHS + 1):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), "best_two_stream_r3d_attn.pth")
