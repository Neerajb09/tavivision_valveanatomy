# training/train_2stream_r2plus1d_attn.py
...
from config.config import RGB_DIR, FLOW_DIR, BATCH_SIZE, EPOCHS, LR, PATIENCE, device
from data.dataset import DualStreamDataset
from model.TwoStream_r2plus1d_32Aff import TwoStreamR2Plus1DAttn
...
model = TwoStreamR2Plus1DAttn(num_classes=len(train_dataset.class_to_idx)).to(device)
...
for epoch in range(1, EPOCHS + 1):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), "best_two_stream_r2plus1d_attn.pth")
